...
//]
const greetings = ['You are ugly','i hate you','youre a loser','i think i killed a cat yesterday' ]
...
function readOutLoud(message){
    ...
    if(message.includes('hi')||message.includes('hello')||message.includes('hey')||message.includes('whats up')){
